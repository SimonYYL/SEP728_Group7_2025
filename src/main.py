...
async def amain()->None:
    ...
    sched_path=settings.base_dir/'data/schedules.json'
    sched=Scheduler(storage_path=str(sched_path), on_fire=None)  # type: ignore
    router=CommandRouter(settings,bus,sched,feeder,camera)
